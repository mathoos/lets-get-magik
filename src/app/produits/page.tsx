...
const produits: Produit[] = [
    {
        id: 1,
        nom: 'Produit 1',
        description: 'Une description géniale pour le produit 1.',
        prix: 29.99,
    ...
    },
    {
        id: 2,
        nom: 'Produit 2',
        description: 'Une description géniale pour le produit 2.',
        prix: 49.99,
    ...
    },
    {
        id: 3,
        nom: 'Produit 3',
        description: 'Une description géniale pour le produit 3.',
        prix: 19.99,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {produits.map((produit) => (
                    <div key={produit.id} className="bg-white p-4 rounded-lg shadow-md">
                        ...
                        <button className="mt-4 w-full py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400">
                            Ajouter au panier
                        </button>
                    </div>
                ))}
